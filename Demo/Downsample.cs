...
public class DownsampleDemo
{
    ...
    public static Bitmap Downsample(Color[,] colors, int factor)
    {
    ...
    public static Bitmap Reconstruct(Color[,] colors)
    {
    ...
    public static Color[,] GetColorsFromText(string path)
    {
    ...
    public static int GetValue(string line, string tag)
    {
